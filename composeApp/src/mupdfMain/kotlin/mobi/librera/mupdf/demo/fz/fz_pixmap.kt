...
class fz_pixmap : Structure(), Structure.ByValue {
    @JvmField var storable: Pointer? = null
    ...
    @JvmField   var n: Byte = 0
    @JvmField   var s: Byte = 0
    @JvmField   var alpha: Byte = 0
    @JvmField   var flags: Byte = 0

    // ptrdiff_t stride
    @JvmField    var stride: Long = 0

    // fz_separations *seps
    @JvmField   var seps: Pointer? = null
    ...
    @JvmField   var colorspace: Pointer? = null

    // unsigned char *samples
    @JvmField   var samples: Pointer? = null

    // fz_pixmap *underlying
    @JvmField    var underlying: Pointer? = null
