...
interface fz_library : Library {
    ...
    fun fz_new_context_imp(alloc: Pointer?,locks: Pointer?, max_store: Int,version: String): Pointer
    ...
    fun fz_new_pixmap_with_bbox(fzContext:Pointer?, device:Pointer?, bbox:fz_irect?, un:Pointer?, alpha:Int):Pointer?
